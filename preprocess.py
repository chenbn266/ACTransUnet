...
parser.add_argument("--data", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS_dataset", help="Path to data directory")
parser.add_argument("--results", type=str, default="/home/user/4TB/Chenbonian/medic-segmention/BraTS_dataset", help="Path for saving results directory")
parser.add_argument(
    "--exec_mode",
    type=str,
    default="test",
...
parser.add_argument("--task", type=str, default='24',help="Number of task to be run. MSD uses numbers 01-10")
