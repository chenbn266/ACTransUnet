...
parser.add_argument("--task", type=str, default="13", help="Path to data")
...
parser.add_argument("--results", type=str, default="/media/administrator/DATA/brain.seg.data/weight_bainian", help="Path to results directory")
